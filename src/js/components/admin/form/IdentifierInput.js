    ...
    <form>
      ...
      {identifier.optional && (
        <>
          {updateRegex && (
            <Row>
              <Col>{updateRegex({ ...identifier })}</Col>
            </Row>
          )}
          ...
          {Array.isArray(identifier.operations) &&
            identifier.operations.map((operation, opIndex) => (
              <Row key={opIndex} className="mb-3">
                <Form.Group
                  as={Col}
                  sm={4}
                  controlId={`identifierOperationOperator${index}${opIndex}`}
                >
                ...
                <Form.Group
                  as={Col}
                  sm={7}
                  controlId={`identifierOperationValue${index}${opIndex}`}
                >
          ...
          <Row>
            <Col>
              <h4>
                ...
                >
                  {showOntology ? "Hide" : "Show"}
                </Button>
              </h4>
              <p>
                We use the TIB Terminology Service to allow you to assign an
                ontology terms to properties.
              </p>
            </Col>
          </Row>
          {showOntology ? (
